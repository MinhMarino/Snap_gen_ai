export const IPC = {
  ...
  importMusicAudio: 'music:importAudio',
  clearMusicAudio: 'music:clearAudio',
  importMusicCharacters: 'music:importCharacters',
  clearMusicCharacters: 'music:clearCharacters',
  ...
  showChoiceDialog: 'dialog:choice',
  ...
  getProjectsRoot: 'projects:getRoot',
